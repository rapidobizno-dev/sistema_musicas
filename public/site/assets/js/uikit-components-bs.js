{
    const { String: t, Boolean: e, Number: n } = window,
        i = (t) => t,
        s = (t, e) => {
            const n = UniCore.util.hyphenate(t);
            (t = UniCore.util.camelize(n)),
                UniCore.util
                    .$$("[uc-" + n + "],[data-uc-" + n + "]")
                    .forEach((e) => {
        ...
        (() => {
            ...
            return i({
                ...
                update: {
                    read({ minHeight: e }) {
                        if (
                            ((this.inactive = !this.matchMedia || !u(this.$el)),
                            this.inactive)
                        )
                            return { minHeight: "auto", prev: e };
                        let n = "";
                        ...
                        if (this.expand)
                            ...
                            !0 === this.offsetBottom
                                ? (n += ` - ${
                                      h(this.$el.nextElementSibling).height
                                  }px`)
                                : c(this.offsetBottom)
                                ? (n += ` - ${this.offsetBottom}vh`)
                                : this.offsetBottom &&
                                  r(this.offsetBottom, "px")
                                ? (n += ` - ${m(this.offsetBottom)}px`)
                                : l(this.offsetBottom) &&
                                  (n += ` - ${
                                      h(p(this.offsetBottom, this.$el)).height
                                  }px`),
                                (n += (i ? ` - ${i}px` : "") + ")");
                        }
                    ...
                    write({ minHeight: t, prev: e }) {
                        s(this.$el, { minHeight: t }),
                            t !== e && this.$update(this.$el, "resize"),
                            this.minHeight &&
                                m(s(this.$el, "minHeight")) < this.minHeight &&
                                s(this.$el, "minHeight", this.minHeight);
                    },
                    events: ["resize"],
                },
            });
    ...
    s(
        ...
        (() => {
            const n = a.mixins[0],
                { $: i, $$: s, empty: o, html: h, isInView: r } = UniCore.util,
                c = {
                    days: "day",
                    hours: "hour",
                    minutes: "minute",
            ...
            return {
                ...
                computed: {
                    ...
                    days: ({ clsWrapper: t }, e) =>
                        i(t.replace("%unit%", "days"), e),
                    hours: ({ clsWrapper: t }, e) =>
                        i(t.replace("%unit%", "hours"), e),
                    minutes: ({ clsWrapper: t }, e) =>
                        i(t.replace("%unit%", "minutes"), e),
                    seconds: ({ clsWrapper: t }, e) =>
                        i(t.replace("%unit%", "seconds"), e),
                    unitValueElement: ({ clsWrapper: t }, e) =>
                        i(t.replace("%unit%", "unit-value"), e),
                    labelElement: ({ clsLabel: t }, e) => i(t, e),
                    units() {
                        const t = ["days", "hours", "minutes", "seconds"];
                        return this.oneUnit ? t : t.filter((t) => this[t]);
                    },
                    hideEnd: ({ clsHideEnd: t }, e) => s(t, e),
                    showEnd: ({ clsShowEnd: t }, e) => s(t, e),
                },
                connected() {
                    this.start();
                },
                disconnected() {
                    this.stop(),
                        ...
                        this.showEnd.forEach((t) =>
                            t.classList.remove("uc-hidden")
                        ),
                        this.hideEnd.forEach((t) =>
                            t.classList.remove("uc-hidden")
                        );
                },
                events: [
                    ...
                    write() {
                        ...
                        if (
                            (t.total <= 0 &&
                                ...
                                this.hideEnd.forEach((t) =>
                                    t.classList.add("uc-hidden")
                                )),
                            this.oneUnit)
                        ) {
                            const e = this.units.find(
                                (e, n, i) =>
                                    Math.floor(t[e]) > 0 || n === i.length - 1
                            );
                            return (
                                (this.labelElement.textContent =
                                    1 === Math.floor(t[e]) ? c[e] : e),
                ...
                methods: {
                    setUnit(e, n, i) {
                        ...
                        (s = this.padZero && s.length < 2 ? `0${s}` : s),
                            n.textContent !== s &&
                                ((s = s.split("")),
                                s.length !== n.children.length &&
                                    h(n, s.map(() => "<span></span>").join("")),
                                s.forEach(
                                    (t, e) => (n.children[e].textContent = t)
                                ));
                    },
                    start() {
                        this.stop(),
                    ...
                    read() {
                        ...
                        if (n) {
                            const { x: e, width: i } =
                                ...
                                s = [e, i].join(",");
                            s === this.lastSeenElPos && (n = !1),
                                (this.lastSeenElPos = s);
                        }
                        return { needUpdate: n };
                    },
                    write({ needUpdate: t }) {
