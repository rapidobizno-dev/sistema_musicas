...
$(function () {
                ...
                series: [
                    {
                        ...
                        data: [10, 45, 10, 75, 35, 80, 40, 10, 15, 25, 80, 100],
                        type: "area",
                    },
                    {
                        name: "Unique Page Views",
                        data: [10, 20, 30, 40, 50, 60, 100, 85, 65, 35, 20, 40],
                        type: "area",
                    },
                    {
                        name: "Unique Impression",
                        data: [10, 20, 30, 40, 50, 60, 70, 80, 85, 90, 95, 89],
                        type: "area",
                    },
                ],
                tooltip: {
    ...
    $(document).ready(function () {
        $('[data-time-countdown="countdown_1"]').timeTo(
            new Date(
                "Tue Feb 23 2024 00:00:00 GMT+0600 (Bangladesh Standard Time)"
            )
        ),
