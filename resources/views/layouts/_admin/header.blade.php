                    ...
                    {{-- <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-timesheets-menu">
                            <div class="d-flex justify-content-between align-items-center timesheets-head">
                                <h6 class="fw-bold text-dark mb-0">Atividades</h6>
                    ...
                    <div class="dropdown nxl-h-item">
                        ...
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-notifications-menu">
                            ...
                            <div class="notifications-item">
                                {{-- <img src="{{ asset('img/news/'. $data->data['image  '])}}" alt="" class="rounded me-3 border"> --}}
                                <div class="notifications-desc">
                                    <a href="{{ route('admin.news.view', ['news' => $data->data['news_id']]) }}" class="font-body text-truncate-2-line"> {{-- <span class="fw-semibold text-dark">{{ $data->data['user'] }}</span> --}} {{ $data->data['title'] }}</a>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="notifications-date text-muted border-bottom border-bottom-dashed">{{ $data->created_at->diffForHumans() }}</div>
                            ...
                            @empty
                                <div class="notifications-item">
                                    <div class="notifications-desc">
                                        <span class="text-muted">Sem notificações</span>
                                    </div>
                                </div>
                            @endforelse
                            {{-- <div class="notifications-item">
                            ...
                            <div class="text-center notifications-footer">
                                <a href="javascript:void(0);" class="fs-13 fw-semibold text-dark">Todas as Notificações</a>
                            </div>
                        </div>
                    </div>
                    <div class="dropdown nxl-h-item">
                        <a href="javascript:void(0);" data-bs-toggle="dropdown" role="button" data-bs-auto-close="outside">
                            <img src="{{ url('assets/images/user.png')}}" alt="user-image" class="img-fluid user-avtar me-0">
                        </a>
                        <div class="dropdown-menu dropdown-menu-end nxl-h-dropdown nxl-user-dropdown">
                            <div class="dropdown-header">
                                <div class="d-flex align-items-center">
                                    <img src="{{ url('assets/images/user.png')}}" alt="user-image" class="img-fluid user-avtar">
                                    <div>
                                        <h6 class="text-dark mb-0">{{ Auth::user()->name ?? " Admin"}} <span class="badge bg-soft-success text-success ms-1">{{ Auth::user()->role ?? "User" }}</span></h6>
                                        <span class="fs-12 fw-medium text-muted">{{Auth::user()->email ?? " admin@hotmail.com"}}</span>
                                    </div>
                                </div>
                            </div>
                            {{-- <div class="dropdown">
                            ...
                            <a href="{{ route('admin.user.show', Auth::user()->id)}}" class="dropdown-item">
                                <i class="feather-menu"></i>
                                <span>Meu Perfil</span>
                            </a>
                            <div class="dropdown-divider"></div>
                            <a href="{{ route('admin.history.index')}}" class="dropdown-item">
