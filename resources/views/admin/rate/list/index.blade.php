            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{ route('admin.rate.create') }}" class="btn btn-dark">
                                        ...
                                        @foreach ($rate as $data)
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                        ...
                                                        <div>
                                                            <span class="text-truncate-1-line">{{ $data->rate.'kz' }}</span>
                                                            {{-- <small
                                                ...
                                                <td>
                                                    <div class="hstack gap-2 justify-content-end">
                                                        <a class="avatar-text avatar-md"
                                                            href="{{ route('admin.rate.show', ['rate' => $data]) }}">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <a class="dropdown-item"
                                                                    href="{{ route('admin.rate.edit', ['rate' => $data]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.rate.delete', ['rate' => $data]) }}">
