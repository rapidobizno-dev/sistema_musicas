...
@section('title', 'Análises e Estatísticas')
@section('content')
        ...
        <div class="page-header">
            <div class="page-header-left d-flex align-items-center">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">Análises e Estatísticas</li>
                </ul>
            </div>
                    ...
                    <div class="card stretch stretch-full">
                        <div class="card-body">
                            <div class="hstack justify-content-between mb-4 pb-">
                                <div>
                                    <h5 class="mb-1">Relatório de Notícias</h5>
                                    <span class="fs-12 text-muted">Relatório de todas as notícias registrados</span>
                                </div>
                                <a href="{{ route('admin.news.index') }}" class="btn btn-light-brand">Ver Todos</a>
                            </div>
                            <div class="row">
                                <div class="col-xxl-2 col-lg-4 col-md-6">
                                    <div class="card stretch stretch-full border border-dashed border-gray-5">
                                        <div class="card-body rounded-3 text-center">
                                            ...
                                            <div class="fs-4 fw-bolder text-dark mt-3 mb-1">{{ $totalNews ?? 'N/A' }}</div>
                                ...
                                <div class="col-xxl-2 col-lg-4 col-md-6">
                                    <div class="card stretch stretch-full border border-dashed border-gray-5">
                                        <div class="card-body rounded-3 text-center">
                                            ...
                                            <div class="fs-4 fw-bolder text-dark mt-3 mb-1">{{ $pendentNews ?? 'N/A' }}
                                            </div>
                                            <p class="fs-12 fw-medium text-muted text-spacing-1 mb-0 text-truncate-1-line">
                                                Notícias Arquivadas</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl-2 col-lg-4 col-md-6">
                                    <div class="card stretch stretch-full border border-dashed border-gray-5">
                                        <div class="card-body rounded-3 text-center">
                                            ...
                                            <div class="fs-4 fw-bolder text-dark mt-3 mb-1">{{ $publishedNews ?? 'N/A' }}
                                            </div>
                                            <p class="fs-12 fw-medium text-muted text-spacing-1 mb-0 text-truncate-1-line">
                                                Notícias Publicadas</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xxl-2 col-lg-4 col-md-6">
                                    <div class="card stretch stretch-full border border-dashed border-gray-5">
                                        <div class="card-body rounded-3 text-center">
                                            ...
                                            <div class="fs-4 fw-bolder text-dark mt-3 mb-1">{{ $draftNews ?? 'N/A' }}</div>
                                            <p class="fs-12 fw-medium text-muted text-spacing-1 mb-0 text-truncate-1-line">
                                                Notícias Rascunho</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-2 col-lg-4 col-md-6">
                                    <div class="card stretch stretch-full border border-dashed border-gray-5">
                                        <div class="card-body rounded-3 text-center">
                                            ...
                                            <div class="fs-4 fw-bolder text-dark mt-3 mb-1">{{ $normalNews ?? 'N/A' }}</div>
                                            <p class="fs-12 fw-medium text-muted text-spacing-1 mb-0 text-truncate-1-line">
                                                Notícias Normais</p>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xxl-2 col-lg-4 col-md-6">
                                    <div class="card stretch stretch-full border border-dashed border-gray-5">
                                        <div class="card-body rounded-3 text-center">
                                            ...
                                            <div class="fs-4 fw-bolder text-dark mt-3 mb-1">{{ $detachNews ?? 'N/A' }}</div>
                                            <p class="fs-12 fw-medium text-muted text-spacing-1 mb-0 text-truncate-1-line">
                                                Notícias Destaque</p>
                                        </div>
                                    </div>
               ...
               {{--  <div class="col-xxl-8">
                    <div class="card stretch stretch-full">
                        <div class="card-header">
                            <h5 class="card-title">Gráfico de Audiências</h5>
                ...
                <div class="col-xxl-4">
                    <div class="card stretch stretch-full">
                        <div class="card-header">
                            <h5 class="card-title">Ranking das Notícias</h5>
                            <div class="card-header-action">
                                <div class="card-header-btn">
                                    <div data-bs-toggle="tooltip" title="Collapse/Expand">
                                        <a href="#" class="avatar-text avatar-xs bg-gray-300"
                        ...
                        <a href="{{ route('admin.news.index') }}"
                            class="card-footer fs-11 fw-bold text-uppercase text-center">Visualizar todas as notícias</a>
                    </div>
                </div>
                <!-- [Browser States] end -->
                <!-- [Mini Card] start -->
                    ...
                    <div class="card stretch stretch-full">
                        <div class="card-body p-0">
                            <div class="d-flex justify-content-between p-4 mb-4">
                                <div>
                                    <div class="fw-bold mb-2 text-dark text-truncate-1-line">Notícias Nacionais</div>
                                    <div class="fs-11 text-muted">Notícias sobre a economia nacional</div>
                                </div>
                                <div class="text-end">
                                    <div class="fs-24 fw-bold mb-2 text-dark"><span class="counter">{{ $nationalPercent ?? 0 }}</span>%</div>
                ...
                <div class="col-xxl-3 col-md-6">
                    <div class="card stretch stretch-full">
                        <div class="card-body p-0">
                            <div class="d-flex justify-content-between p-4 mb-4">
                                <div>
                                    <div class="fw-bold mb-2 text-dark text-truncate-1-line">Notícias Internacionais</div>
                                    <div class="fs-11 text-muted">Notícias sobre a economia internacional</div>
                                </div>
                                <div class="text-end">
                                    <div class="fs-24 fw-bold mb-2 text-dark"><span class="counter">{{ $internationalPercent ?? 0}}</span>%</div>
                ...
                <div class="col-xxl-3 col-md-6">
                    <div class="card stretch stretch-full">
                        <div class="card-body p-0">
                            <div class="d-flex justify-content-between p-4 mb-4">
                                <div>
                                    <div class="fw-bold mb-2 text-dark text-truncate-1-line">Tecnologias & Inovações</div>
                                    <div class="fs-11 text-muted">Notícias sobre tecnologias e inovações</div>
                                </div>
                                <div class="tx-right">
                                    <div class="fs-24 fw-bold mb-2 text-dark"><span class="counter">{{ $TechnologyinnovationPercent ?? 0 }}</span>%</div>
                ...
                <div class="col-xxl-3 col-md-6">
                    <div class="card stretch stretch-full">
                        <div class="card-body p-0">
                            <div class="d-flex justify-content-between p-4 mb-4">
                                <div>
                                    <div class="fw-bold mb-2 text-dark text-truncate-1-line">Negócios</div>
                                    <div class="fs-11 text-muted">Notícias sobre negócios</div>
                                </div>
                                <div class="tx-right">
                                    <div class="fs-24 fw-bold mb-2 text-dark"><span class="counter">{{ $businessPercent ?? 0 }}</span>%</div>
                ...
                @if ($filedNews->count() > 0)
                    <!-- [Notícias Arquivadas] start -->
                    <div class="col-xxl-6">
                        <div class="card stretch stretch-full">
                            <div class="card-header">
                                <h5 class="card-title">Notícias Arquivadas</h5>
                                <div class="card-header-action">
                                    <div class="card-header-btn">
                                        <div data-bs-toggle="tooltip" title="Delete">
                                            <a href="javascript:void(0);" class="avatar-text avatar-xs bg-danger"
                                                        ...
                                                        <div class="hstack gap-2">
                                                            ...
                                                            <div class="border-3 border-start rounded ps-3">
                                                                <a href="javascript:void(0);" class="mb-2 d-block">
                                                                    <span>{{ Str::limit($data->title, 50, '...') }}</span>
                                                                </a>
                                                                <p class="fs-12 text-muted mb-0">
                                                                    {{ Str::limit($data->subtitle, 70, '...') }}</p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        @if ($data->detach == 'normal')
                                                            <span
                                                                class="badge bg-soft-primary text-primary">{{ $data->detach }}</span>
                                                        @elseif($data->detach == 'destaque')
                                                            <span
                                                                class="badge bg-soft-warning text-warning">{{ $data->detach }}</span>
                                                        @elseif($data->detach == 'urgente')
                                                            <span
                                                                class="badge bg-soft-danger text-danger">{{ $data->detach }}</span>
                                                        @endif
                                                    </td>
                                                    <td>
                ...
                @endif
                @if ($draftedNews->count() > 0)
                    <!-- [Notícias Rascunho] start -->
                    <div class="col-xxl-6">
                        <div class="card stretch stretch-full">
                            <div class="card-header">
                                <h5 class="card-title">Notícias Rascunho</h5>
                                <div class="card-header-action">
                                    <div class="card-header-btn">
                                        <div data-bs-toggle="tooltip" title="Delete">
                                            <a href="javascript:void(0);" class="avatar-text avatar-xs bg-danger"
