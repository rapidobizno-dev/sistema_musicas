...
@section('title', 'Radar Econômico - Listar Comentários')
@section('content')
            ...
            <div class="page-header-right ms-auto">
                <div class="page-header-right-items">
                    ...
                    {{-- <div class="d-flex align-items-center gap-2 page-header-right-items-wrapper">
                        ...
                        <a href="{{ route('admin.comment.create') }}" class="btn btn-dark">
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <a href="javascript:void(0)" class="hstack gap-3">
                                                        <div>
                                                            <span
                                                                class="text-truncate-1-line">{{ $comment->comment }}</span>
                                                            {{-- <small
                                                                class="fs-12 fw-normal text-muted">alex.della@outlook.com</small> --}}
                                                        </div>
                                                    </a>
                                                </td>
                                                <td class="fw-bold text-dark">{{ $comment->first_name . ' ' . $comment->last_name }}</td>
