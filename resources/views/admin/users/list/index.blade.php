...
@section('title', 'Radar Econômico - Lisar Utilizadores')
@section('content')
                                            ...
                                            <tr class="single-item">
                                                ...
                                                <td>
                                                    <div class="hstack gap-2">
                                                        <span class="text-truncate-1-line">{{ $data->id }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="hstack gap-3">
                                                        <span class="text-truncate-1-line">{{ $data->name }}</span>
                                                    </div>
                                                </td>
                                                </td>
                                                <td>
                                                    <div class="hstack gap-3">
                                                        <span class="text-truncate-1-line">{{ $data->email }}</span>
                                                    </div>
                                                </td>
                                                </td>
                                                <td>
                                                    <div class="hstack gap-3">
                                                        <span class="text-truncate-1-line">{{ $data->role }}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.user.edit', ['user' => $data]) }}">
                                                                ...
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('admin.user.delete', ['user' => $data]) }}">
