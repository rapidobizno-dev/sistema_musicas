...
@section('title', 'Radar Economico - Opinioes')
@section('content')
        ...
        <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
            <div class="container max-w-xl">
                <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                    ...
                    <li><span class="opacity-50">Opiniões & Análises</span></li>
                </ul>
            </div>
        </div>
            ...
            <div class="container max-w-xl">
                <div class="panel vstack gap-3 sm:gap-6 lg:gap-9">
                    <header class="page-header vstack justify-center items-center text-center max-w-500px mx-auto">
                        <h1 class="h4 lg:h1">Opiniões & Análises</h1>
                        <p class="fs-6 lg:fs-5 opacity-60">Promovendo a liberdade de espressão, conteúdos imergentes e
                            opiniões públicas.</p>
                    </header>
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h4 m-0 text-truncate-2 m-0">
                                                        <a class="text-none"
                                                            href="javascript:voit(0)">{{ $data->title }}</a>
                                                    </h3>
                                                    <div>
                                                        <div
                                                                        ...
                                                                        <{{-- div class="post-author hstack gap-1">
                                                                            <a href="page-author.html"
                                                                                data-uc-tooltip="Jason Blake"><img
                                                                                    src="{{ url('site/assets/images/avatars/05.png')}}"
                                                                                    alt="Jason Blake"
