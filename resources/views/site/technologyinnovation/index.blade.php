...
@section('title', 'Radar Economico - Tecnologia & Invovacoes')
@section('content')
        ...
        <div class="breadcrumbs panel z-1 py-2 bg-gray-25 dark:bg-gray-100 dark:bg-opacity-5 dark:text-white">
            <div class="container max-w-xl">
                <ul class="breadcrumb nav-x justify-center gap-1 fs-7 sm:fs-6 m-0">
                    ...
                    <li><span class="opacity-50">Tecnologia e Inovações</span></li>
                </ul>
            </div>
        </div>
            ...
            <div class="container max-w-xl">
                <div class="panel vstack gap-3 sm:gap-6 lg:gap-9">
                    <header class="page-header vstack justify-center items-center text-center max-w-500px mx-auto">
                        <h1 class="h4 lg:h1">Tecnologia e Inovações</h1>
                        <p class="fs-6 lg:fs-5 opacity-60">Notícias do mercado econômico angolano.</p>
                    </header>
                                            ...
                                            <article class="post type-post panel vstack gap-2">
                                                <div class="post-image panel overflow-hidden">
                                                    ...
                                                    <div
                                                        ...
                                                        <a class="text-none" href="{{ route('site.technologyinnovation')}}">{{ $data->category->name }}</a>
                                                    </div>
                                                    <div
                                                ...
                                                <div class="post-header panel vstack gap-1 lg:gap-2">
                                                    <h3 class="post-title h6 sm:h5 xl:h3 m-0 text-truncate-2 m-0">
                                                        <a class="text-none"
                                        ...
                                        <article class="post type-post panel vstack gap-2">
                                            <div class="post-image panel overflow-hidden">
                                                <figure
                                                    ...
                                                    <img class="media-cover img image uc-transition-scale-up uc-transition-opaque"
                                                        src="../assets/images/common/img-fallback.png"
                                                        data-src="../assets/images/demo-eight/posts/img-13.jpg"
                                                        alt="Tech Tools for your Time Management: Enhancing Productivity"
                                                        data-uc-img="loading: lazy">
                                                    <a href="blog-details.html" class="position-cover"
                                                        data-caption="Tech Tools for your Time Management: Enhancing Productivity"></a>
                                                </figure>
                                                <div
                                                    class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                    <a class="text-none" href="blog-category.html">Startups</a>
                                            ...
                                            <div class="post-header panel vstack gap-1 lg:gap-2">
                                                <h3 class="post-title h6 sm:h5 xl:h3 m-0 text-truncate-2 m-0">
                                                    <a class="text-none" href="blog-details.html">Tech Tools for your Time
                                        ...
                                        <article class="post type-post panel vstack gap-2">
                                            <div class="post-image panel overflow-hidden">
                                                <figure
                                                    ...
                                                    <img class="media-cover img image uc-transition-scale-up uc-transition-opaque"
                                                        src="../assets/images/common/img-fallback.png"
                                                        data-src="../assets/images/demo-eight/posts/img-14.jpg"
                                                        alt="A Guide to The Rise of Gourmet Street Food: Trends and Top Picks"
                                                        data-uc-img="loading: lazy">
                                                    <a href="blog-details.html" class="position-cover"
                                                        data-caption="A Guide to The Rise of Gourmet Street Food: Trends and Top Picks"></a>
                                                </figure>
                                                <div
                                                    class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                    <a class="text-none" href="blog-category.html">AI Powered</a>
                                            ...
                                            <div class="post-header panel vstack gap-1 lg:gap-2">
                                                <h3 class="post-title h6 sm:h5 xl:h3 m-0 text-truncate-2 m-0">
                                                    <a class="text-none" href="blog-details.html">A Guide to The Rise of
                                        ...
                                        <article class="post type-post panel vstack gap-2">
                                            <div class="post-image panel overflow-hidden">
                                                <figure
                                                    ...
                                                    <img class="media-cover img image uc-transition-scale-up uc-transition-opaque"
                                                        src="../assets/images/common/img-fallback.png"
                                                        data-src="../assets/images/demo-eight/posts/img-15.jpg"
                                                        alt="Gaming in the Age of AI: Strategies for Startups"
                                                        data-uc-img="loading: lazy">
                                                    <a href="blog-details.html" class="position-cover"
                                                        data-caption="Gaming in the Age of AI: Strategies for Startups"></a>
                                                </figure>
                                                <div
                                                    class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                                    <a class="text-none" href="blog-category.html">Virtual Reality</a>
                                            ...
                                            <div class="post-header panel vstack gap-1 lg:gap-2">
                                                <h3 class="post-title h6 sm:h5 xl:h3 m-0 text-truncate-2 m-0">
                                                    <a class="text-none" href="blog-details.html">Gaming in the Age of AI:
                                        ...
                                        <article class="post type-post panel vstack gap-2">
                                            <div class="post-image panel overflow-hidden">
                                                <figure
                                                    ...
                                                    <img class="media-cover img image uc-transition-scale-up uc-transition-opaque"
                                                        src="../assets/images/common/img-fallback.png"
                                                        data-src="../assets/images/demo-eight/posts/img-16.jpg"
                                                        alt="Top Independent Contractors to Invest in Best of Startups"
                                                        data-uc-img="loading: lazy">
                                                    <a href="blog-details.html" class="position-cover"
                                                        data-caption="Top Independent Contractors to Invest in Best of Startups"></a>
                                                </figure>
                                                <div
                                                    class="post-category hstack gap-narrow position-absolute top-0 start-0 m-1 fs-7 fw-bold h-24px px-1 rounded-1 shadow-xs bg-white text-primary">
                                            ...
                                            <div class="post-header panel vstack gap-1 lg:gap-2">
                                                <h3 class="post-title h6 sm:h5 xl:h3 m-0 text-truncate-2 m-0">
                                                    <a class="text-none" href="blog-details.html">Top Independent
